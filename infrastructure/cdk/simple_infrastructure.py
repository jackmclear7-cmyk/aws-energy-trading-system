#!/usr/bin/env python3
"""
Simple CDK Stack for Energy Trading System Infrastructure

This stack deploys only the foundational AWS resources without ECS services.
"""
...
class SimpleEnergyTradingStack(Stack):
    """
    Simple CDK stack that deploys foundational infrastructure only.
    """
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        for table_id, table_name in table_configs:
            self.timestream_tables[table_id] = timestream.CfnTable(
                self, f"{table_id.title()}Table",
